...
$kyc_desc = ($user_kyc !== NULL && isset($_GET['thank_you'])) ? __('Verify your identity to participate in token sale.') : __('To comply with regulation each participant will have to go through identity verification (KYC/AML) to prevent fraud causes. Please, complete our fast and secure verification process to participate in our token sale.');
@endphp
                    ...
                    <div class="card-innr">
                        ...
                        <div class="status status{{ ($user_kyc->status == 'missing') ? '-warnning' : '-canceled' }}">
                            ...
                            <span class="status-text text-dark">
                                {{ $user_kyc->status == 'missing' ? 'We found some information are missing.' : 'Sorry! Your application has been rejected.' }}
                            </span>
                            <p class="px-md-5">{{__('In our verification process, we found information are incorrect or missing. It would great if you resubmit the form. If face problem in submission please contact us with support team.')}}</p>
                        ...
                        <div class="status status-verified">
                            ...
                            <p class="px-md-5">{{__('One of our team member verified your identity. Now you can participate in our token sale. Thank you.')}}</p>
