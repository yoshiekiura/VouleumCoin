        ...
        <div class="modal-content">
            ...
            <div id="base-body" class="popup-body-full">
                ...
                <div class="popup-header">
                    ...
                    <p>You can manage currency what you want to use in payment system. You can use one or multiple currency from bellow option.</p>
                </div>
                            ...
                            <div class="input-item">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <span {{ field_value('kyc_public') == 1 ? '' : 'class="d-none"' }}>Public KYC Application Url : <a href="{{ route('public.kyc') }}">{{ route('public.kyc') }}</a></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="kyc-option-content toggle-content">
                                    ...
                                    <div class="input-item input-with-label">
                                        ...
                                        <div class="input-wrap">
                                            <select  name="kyc_wallet_opt[]" class="select select-block select-bordered" value="" data-placeholder="Select Options" multiple="multiple">
                                                <option {{in_array('ethereurm', $wallet_opt )? 'selected' : ''}} value="ethereurm">Ethereurm</option>
                                                <option {{in_array('bitcoin', $wallet_opt)? 'selected' : ''}} value="bitcoin">Bitcoin</option>
                                                <option {{in_array('litecoin', $wallet_opt)? 'selected' : ''}} value="litecoin">Litecoin</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row guttar-15px align-items-center">
                                ...
                                <div class="col-sm-3 col-6">
                                   <div class="input-item input-with-label">
                                        <div class="input-wrap">
                                            <input class="input-bordered" placeholder="wallet-name" type="text" name = "kyc_wallet_custom[]" value="{{$custom['cw_name']}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3 col-6">
                                    <div class="input-item input-with-label">
                                        <div class="input-wrap">
                                            <input class="input-bordered" placeholder="Wallet Label" type="text" name="kyc_wallet_custom[]" value="{{$custom['cw_text']}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
