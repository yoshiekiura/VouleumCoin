...
<head>
    ...
    <title>{{(!empty($check_dt) && count($check_dt) >= 14 )? "Tokenlite Installation ":"Database Error"}}</title>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-7 col-xl-5 text-center">
                    <div class="error-content">
                        @if(isset($check_dt) && count($check_dt) >= 14)  
                        ...
                        @else  
                            ...
                            <a href="{{ url('/') }}" class="btn btn-primary btn-outline">Back to Home</a>
                        @endif
                    </div>
                </div>
            </div>
