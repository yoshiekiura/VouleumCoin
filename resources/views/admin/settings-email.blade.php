            ...
            <div class="main-content col-lg-12">
                <div class="content-area card">
                    <div class="card-innr">
                        ...
                        <div class="guttar-vr-10px guttar-50px row">
                            <div class="col-md-6">
                                <ul class="list list-s1">
                                    @foreach($templates as $item)
                                    @if(!starts_with($item->slug, 'order-'))
                                    <li class="item">
                                ...
                                <ul class="list list-s1">
                                    ...
                                    <li class="item">
                                        <div class="list-content justify-content-between">
                                            ...
                                            <div class="d-flex guttar-10px">
                                                <div class="div">
                                                    <a class="btn btn-circle btn-xs btn-icon btn-lighter et-item" href="javascript:void(0)" data-slug="{{ $item->slug }}" data-id="{{ $item->id }}"><em class="far fa-edit"></em></a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                        ...
                        <div class="row" id="smtp-box">
                            ...
                            <div class="col-sm-6">
                                <div class="input-item input-with-label">
                                    ...
                                    <input class="input-bordered" type="text" name="site_mail_username" placeholder="smtp@mailtrap.io" value="{{ (Auth::user()->type == 'demo')? "hide@ouremail.address" : email_setting('user_name', env('MAIL_USERNAME')) }}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="input-item input-with-label">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="input-item input-with-label">
                                    ...
                                    <input class="input-bordered" type="email" name="site_mail_from_address" value="{{ email_setting('from_address') }}" placeholder="admin@icopanel.com" >
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-item input-with-label">
                                    <label class="input-item-label">Email From Name</label>
                                    <input class="input-bordered" type="text" name="site_mail_from_name" value="{{ email_setting('from_name') }}" placeholder="Admin" >
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="input-item input-with-label">
