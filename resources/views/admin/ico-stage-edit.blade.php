        ...
        <div class="card content-area">
            <div class="card-innr">
                <div class="card-head d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0">ICO Stage Update</h4>
                    <div class="d-flex guttar-15px">
                        <div class="fake-class">
                            <span class="badge badge-lg badge-dim badge-lighter d-none d-md-inline-block">Sold: {{ number_format($ico->sales_token, 2).' '. token_symbol() }}</span>
                        </div>
                        <div class="fake-class">
                        ...
                        <form action="{{ route('admin.ajax.stages.update') }}" class="_reload validate-modern" method="POST" id="ico_stage" autocomplete="off">
                            ...
                            <div id="stageDetails" class="wide-max-md">
                                ...
                                <div class="input-item input-with-label">
                                    <label class="input-item-label">ICO Stage Title/Name
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-item input-with-label">
                                           ...
                                           <div class="input-wrap">
                                            ...
                                            <span class="input-note">Define your token rate. Usually $0.003 USD per token.</span>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="input-item input-with-label">
                                        ...
                                        <div class="row">
                                            <div class="col-sm">
                                                <div class="input-item input-with-label">
                                                   ...
                                                   <div class="input-wrap">
                                                    <input class="input-bordered" type="number" name="soft_cap" value="{{ ($ico->soft_cap > 1 ? $ico->soft_cap : '') }}" max="{{ ((int) $ico->total_tokens / 2) }}">
                                               </div>
                                                </div>
                                            </div>
                                            <div class="col-sm">
                                            ...
                                            <div class="col-12">
                                                <div class="input-item input-with-label d-none">
                                    ...
                                    <div class="stage-tire-item">
                                        ...
                                        <div class="stage-tire-title">
                                            <div class="input-item pb-0">
                                                <input class="input-switch input-switch-left switch-toggle" data-switch="switch-to-priceTire0{{ $i }}" {{ $pd->$tire->status == 1 ? 'checked' : '' }}  type="checkbox" id="priceTire0{{ $i }}" name="ptire_{{ $i }}" value="1">
                                                <label for="priceTire0{{ $i }}"></label>
                                            </div>
                                            <span class="h5">Price Tire - 0{{ $i }}</span>
                                        </div>
                                        <div class="switch-content switch-to-priceTire0{{ $i }} wide-max-md">
                                            <div class="row">
                                                <div class="col-md">
                                                    <div class="input-item input-with-label">
                                                        ...
                                                        <div class="input-wrap">
                                                            ...
                                                            <span class="input-note">Base Price: <span>{{ $ico->base_price }}$</span></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md">
                                                    <div class="input-item input-with-label">
                                                        ...
                                                        <div class="input-wrap">
                                                            <input class="input-bordered" type="number" name="ptire_{{ $i }}_min_purchase" min="1" value="{{ $pd->$tire->min_purchase }}">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="pdb-2x">
                                        <div class="row guttar-15px guttar-vr-5px align-items-center">
                                           ...
                                           <div class="col">
                                            <div class="input-sub-label">Tire {{ $i }}</div>
                                        </div>
                                    </div>
                                </div>
                                @endfor
