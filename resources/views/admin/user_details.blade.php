            ...
            <div class="card-innr card-innr-fix">
                <div class="card-head d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center guttar-20px">
                        <div class="flex-col d-sm-block d-none">
                            <a href="{{route('admin.users')}}" class="btn btn-sm btn-auto btn-primary"><em class="fas fa-arrow-left mr-3"></em>Back</a>
                        </div>
                ...
                <ul class="data-details-list">
                    ...
                    <li>
                        ...
                        <div class="data-details-des">{!! $user->lastLogin ? _date($user->lastLogin) : '<small class="text-light">No logging yet!</small>' !!}</div>
                    </li>{{-- li --}}
                </ul>
            </div>{{-- .card-innr --}}
        </div>{{-- .card --}}
