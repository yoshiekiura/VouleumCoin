        ...
        <div class="card content-area">
            <div class="card-innr">
                <div class="card-head d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0">KYC Information of <span>{{ $kyc->firstName.' '.$kyc->lastName }}</h4>
                    ...
                    <ul class="data-details-list">
                        <li>
                            ...
                            <div class="data-details-des">{!! ($kyc->firstName) ? $kyc->firstName : $space !!}</div>
                        </li>{{-- li --}}
                        <li>
                            <div class="data-details-head">Last Name</div>
                            <div class="data-details-des">{!! ($kyc->lastName) ? $kyc->lastName : $space !!}</div>
                        </li>{{-- li --}}
                        <li>
                            <div class="data-details-head">Email Address</div>
                            <div class="data-details-des">{!! ($kyc->email) ? $kyc->email : $space !!}</div>
                        </li>{{-- li --}}
                        <li>
                            <div class="data-details-head">Phone Number</div>
                            <div class="data-details-des">{!! ($kyc->phone) ? $kyc->phone : $space !!}</div>
                        </li>{{-- li --}}
                        <li>
                        ...
                        <li>
                            ...
                            <div class="data-details-des">{!! ($kyc->country) ? $kyc->country : $space !!}</div>
                        </li>{{-- li --}}
                        <li>
                            <div class="data-details-head">Wallet Type</div>
                            <div class="data-details-des">{!! ($kyc->walletName) ? $kyc->walletName : $space !!}</div>
                        </li>{{-- li --}}
                        <li>
                            <div class="data-details-head">Wallet Address</div>
                            <div class="data-details-des">{!! ($kyc->walletAddress) ? $kyc->walletAddress : $space !!}</div>
                        </li>{{-- li --}}
                        <li>
                            <div class="data-details-head">Telegram Username</div>
                            <div class="data-details-des">
                                @if ($kyc->telegram)
                                <span>{{ '@'.preg_replace('/@/', '', $kyc->telegram, 1) }}</span><a href="https://t.me/{{preg_replace('/@/', '', $kyc->telegram, 1)}}" target="_blank"><em class="far fa-paper-plane"></em></a>
                                @else 
                                &nbsp;
                                @endif
                            </div>
